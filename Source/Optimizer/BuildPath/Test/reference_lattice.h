...
extern c_ideal_t reference_poset[5][2];
extern t_edge reference_tree[15];
extern t_edge reference_lattice[26];
extern c_ideal_t reference_le[20][REFERENCE_POSET_N];
extern c_count_t reference_counts[16];
...
c_count_t reference_counts2[11];
