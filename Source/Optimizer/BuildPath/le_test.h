...
c_itemid_t node2id[] = { 103, 138, 21, 131, 15, 15 };

c_ideal_t ideals[][LE_T_ADJACENCY_MAX] = { { 0, 0, 0 }, { 3, 5, 6 }, { 1, 5, 6 }, { 3, 6, 0 }, { 3, 5, 0 }, { 5, 6, 0 }, { 1,
6, 0 }, { 1, 5, 0 }, { 3, 4, 0 }, { 6, 0, 0 }, { 5, 0, 0 }, { 1, 4, 0 }, { 3,
0, 0 }, { 4, 0, 0 }, { 1, 0, 0 }, { 2, 0, 0 }, { 0, 0, 0 } };

c_index_t adjacency[][LE_T_ADJACENCY_MAX] = { { 0, 0, 0 }, { 2, 3, 4 }, { 5, 6, 7 }, { 6, 8, 0 }, { 7, 8,
