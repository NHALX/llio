...
void opencl_buildfilev(opencl_context *ctx, char *kernel_function[], size_t kernel_n, char *source_file[], size_t source_n, char *build_flags);
int opencl_build(opencl_context *ctx, char *kernel_function, char *source, char *build_flags);
int opencl_buildv(opencl_context *ctx, char *kernel_function[], size_t kernel_n, char *source[], size_t source_n, char *build_flags);
